...
Dynamsoft.WebTwain.prototype.FTPDownload = function(FTPServer, FTPRemoteFile, optionalAsyncSuccessFunc, optionalAsyncFailureFunc) {
    ...
    /// <param name="optionalAsyncSuccessFunc" type="function" optional="true">optional. The function to call when the download succeeds.</param>
    /// <param name="optionalAsyncFailureFunc" type="function" optional="true">optional. The function to call when the download fails.</param>
    /// <returns type="bool"/>
};
...
Dynamsoft.WebTwain.prototype.FTPUpload = function(FTPServer, sImageIndex, FTPRemoteFile, optionalAsyncSuccessFunc, optionalAsyncFailureFunc) {
    ...
    /// <param name="optionalAsyncSuccessFunc" type="function" optional="true">optional. The function to call when the upload succeeds.</param>
    /// <param name="optionalAsyncFailureFunc" type="function" optional="true">optional. The function to call when the upload fails.</param>
    /// <returns type="bool"/>
};
...
Dynamsoft.WebTwain.prototype.HTTPUploadThroughPost = function(HTTPServer, sImageIndex, ActionPage, fileName, optionalAsyncSuccessFunc, optionalAsyncFailureFunc) {
    ...
    /// <param name="HTTPServer" type="string">the name of the HTTP server.</param>
    /// <param name="sImageIndex" type="short">specifies the index of image in buffer. The index is 0-based. </param>
    /// <param name="ActionPage" type="string">the specified page for posting image files. This is the relative path of the page, not the absolute path. For example: "upload.asp", not "http://www.webserver.com/upload.asp". This is the page corresponds to the action in <form> html tag: <form id = "frmSample" action = "upload.asp" method = post>...</form></param>
...
Dynamsoft.WebTwain.prototype.HTTPUploadThroughPostDirectly = function(HTTPServer, localFile, ActionPage, fileName, optionalAsyncSuccessFunc, optionalAsyncFailureFunc) {
    ...
    /// <param name="ActionPage" type="string">the specified page for posting files. This is the relative path of the page, not the absolute path. For example: "upload.asp", not "http://www.webserver.com/upload.asp". This is the page corresponds to the action in <form> html tag: <form id = "frmSample" action = "upload.asp" method = post>...</form></param>
...
Dynamsoft.WebTwain.prototype.HTTPUploadThroughPostEx = function(HTTPServer, sImageIndex, ActionPage, fileName, lImageType, optionalAsyncSuccessFunc, optionalAsyncFailureFunc) {
    ...
    /// <param name="optionalAsyncSuccessFunc" type="function" optional ="true">optional. The function to call when the upload succeeds.</param>
    /// <param name="optionalAsyncFailureFunc" type="function" optional ="true">optional. The function to call when the upload succeeds.</param>
    /// <returns type="bool"/>
};
...
Dynamsoft.WebTwain.prototype.LoadDibFromClipboard = function(optionalAsyncSuccessFunc, optionalAsyncFailureFunc) {
    ...
    /// <param name="optionalAsyncSuccessFunc" type="function" optional ="true">optional. The function to call when the loading succeeds.</param>
    /// <param name="optionalAsyncFailureFunc" type="function" optional ="true">optional. The function to call when the loading fails.</param>
    /// <returns type="bool"/>
};
...
Dynamsoft.WebTwain.prototype.SaveAllAsMultiPageTIFF = function(localFile, optionalAsyncSuccessFunc, optionalAsyncFailureFunc) {
    ...
    /// <param name="optionalAsyncSuccessFunc" type="function" optional ="true">optional. The function to call when the saving succeeds.</param>
    /// <param name="optionalAsyncFailureFunc" type="function" optional ="true">optional. The function to call when the saving fails.</param>
    /// <returns type="bool"/>
};
...
Dynamsoft.WebTwain.prototype.SaveAsBMP = function(localFile, sImageIndex) {
    ...
    /// <param name="localFile" type="string">the name of the BMP file to be saved. It should be an absolute path on the local disk.s</param>
    /// <param name="sImageIndex" type="short">specifies the index of image in buffer. The index is 0-based.</param>
    /// <returns type="bool"/>
};
...
Dynamsoft.WebTwainEnv.GetWebTwain = function(cid) {
    /// <summary>GetWebTwain</summary>
    /// <param name="cid" type="string">WebTwain Container ID</param>
